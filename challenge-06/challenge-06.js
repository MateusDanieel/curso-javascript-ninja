...
desafio.
*/
var teams = [ 'Santos', 'Palmeiras', 'São Paulo', 'Corinthians', 'Bragantino' ];
...
function showTeamPosition(x) {
    ...
    switch(x) {
        case 0:
            return 'O time que está em 1º lugar é o ' + teams[x] + '.';
            break;
        case 1:
            return 'O time que está em 2º lugar é o ' + teams[x] + '.';
            break;
        case 2:
            return 'O time que está em 3º lugar é o ' + teams[x] + '.';
            break;
        case 3:
            return 'O time que está em 4º lugar é o ' + teams[x] + '.';
            break;
        case 4:
            return 'O time que está em 5º lugar é o ' + teams[x] + '.';
            break;
        default:
...
*/
console.log( showTeamPosition(0) ); // 'O time que está em 1º lugar é o Santos.'
console.log( showTeamPosition(1) ); // 'O time que está em 2º lugar é o Palmeiras.'
console.log( showTeamPosition(2) ); // 'O time que está em 3º lugar é o São Paulo.'
console.log( showTeamPosition(3) ); // 'O time que está em 4º lugar é o Corinthians.'
