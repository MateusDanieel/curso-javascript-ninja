...
carro.add = function(p){
    
  var disp = carro.assentos - carro.quantidadePessoas;

  if(disp === 0){
      return 'O carro já está lotado!'
  } else if (disp > 0 && p > disp){
      return 'Só cabem mais ' + disp + (disp === 1 ? ' pessoa!' : ' pessoas!');  
  } else {
...
carro.obterMarcaModelo(); // "Esse carro é um Ferrari Enzo"
