...
console.log( multiplication(20, 5) ); // Resultado da operação: 20 * 5 = 100
console.log( division(16, 2) ); // Resultado da operação: 16 / 2 = 8
console.log( mod(18, 3) ); // Resultado da operação: 18 % 3 = 0
