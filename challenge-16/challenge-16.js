(function() {
    ...
    */
    ...
    for(var i = 0; i < name.length; i++) {
        var count = i + 1;
        console.log( name[i].toUpperCase() + ' é a ' + count + 'ª letra do meu nome.' );
    }
    ...
    */
    ...
    var nomes = ['Mateus', 'Daniel', 'Jaqueline', 'Maria', 'Alice'];

    var newNomes = nomes.reduce(function(acumulado, atual, index, array) {
        return acumulado + ( (index + 1) === array.length ? 'e ' + atual + ' ' : atual + ', ' );
    }, '');
    ...
    */
    ...
    console.log( roberto.split('').map(function(item, index, array) {
        return (index + 1) === array.length ? item.replace('o', 'a') : item;
    ...
    */
    ...
    var newMyName = myName.split('').map(function(item, index) {
        return index % 2 === 0 ? item.toUpperCase() : item.toLowerCase();
    }).reduce(function(acumulado, atual, index, array) {
        return acumulado + atual;
    }, '');
